...
import { Menu, Search, Bell, Moon, ArrowLeft, Play } from 'lucide-react';
import EpisodeForm from '@/components/admin/forms/EpisodeForm';

export const metadata = {
  title: 'Add Episode | MugiSub Admin',
  description: 'Register a new episode entry for an anime series.',
};
...
export default function AddEpisodePage() {
  return (
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <div className="fixed top-0 left-1/4 w-[500px] h-[500px] bg-cyan-900/10 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">Add Episode</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">Register a new episode entry for an anime series.</p>
            </div>
          </div>
