...
import { Menu, Search, Bell, Moon, ArrowLeft, MessageCircle } from 'lucide-react';
import ForumsTable from '@/components/admin/tables/ForumsTable';

export const metadata = {
  title: 'Forum Moderation | MugiSub Admin',
  description: 'Review and moderate forum threads and user posts.',
};
...
export default function ForumsPage() {
  return (
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <div className="fixed top-0 left-1/4 w-[500px] h-[500px] bg-teal-900/10 rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="fixed top-1/3 right-1/4 w-[400px] h-[400px] bg-teal-900/8 rounded-full blur-[100px] pointer-events-none z-0" />
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">Forum Moderation</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">Review and moderate forum threads and user posts.</p>
            </div>
          </div>
