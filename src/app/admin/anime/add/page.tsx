...
import { Menu, Search, Bell, Moon, ArrowLeft, Tv } from 'lucide-react';
import AnimeForm from '@/components/admin/forms/AnimeForm';

export const metadata = {
  title: 'Add Anime | MugiSub Admin',
  description: 'Upload a new anime series or movie to the MugiSub platform.',
};
    ...
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 w-full bg-[#111622]/90 backdrop-blur-md border-b border-[#1d2433] px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/admin"
            className="text-xs bg-[#121824] border border-[#1d2433] hover:border-[#a855f7]/60 text-slate-300 hover:text-white px-3 py-1 font-mono transition-all flex items-center gap-1"
          >
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono text-slate-600 mb-6">
          ...
          <span>/</span>
          <span className="text-slate-400">anime</span>
          <span>/</span>
        ...
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">
                Add a new series or movie to the platform database.
              </p>
            </div>
          </div>
          ...
          <Link
            href="/admin"
            className="text-xs font-mono text-purple-400 hover:text-purple-300 flex items-center gap-1 bg-[#111622] hover:bg-[#1d2433] border border-[#1d2433] px-3 py-1.5 transition-all"
          >
            <ArrowLeft className="w-3.5 h-3.5" />
