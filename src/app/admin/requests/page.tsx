...
import { Menu, Search, Bell, Moon, ArrowLeft, Wrench } from 'lucide-react';
import EditRequestsTable from '@/components/admin/tables/EditRequestsTable';

export const metadata = {
  title: 'Edit Requests | MugiSub Admin',
  description: 'Review and approve community-submitted content edits.',
};
...
export default function EditRequestsPage() {
  return (
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <div className="fixed top-1/3 right-1/4 w-[400px] h-[400px] bg-yellow-900/8 rounded-full blur-[100px] pointer-events-none z-0" />
      ...
      {/* Main Content */}
      <main className="relative z-10 mx-auto max-w-5xl px-4 pt-10 pb-20">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-[10px] font-mono text-slate-600 mb-6">
          ...
          <span>/</span>
          <span className="text-yellow-400">requests</span>
        </div>

        {/* Page Header */}
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-yellow-500/10 border border-yellow-500/20 text-yellow-400">
              <Wrench className="w-5 h-5" />
            </div>
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">Edit Requests</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">Review and approve community-submitted content edits.</p>
            </div>
          </div>
