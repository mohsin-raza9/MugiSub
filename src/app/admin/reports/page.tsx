...
import { Menu, Search, Bell, Moon, ArrowLeft, AlertTriangle } from 'lucide-react';
import ReportsTable from '@/components/admin/tables/ReportsTable';

export const metadata = {
  title: 'Content Reports | MugiSub Admin',
...
export default function ReportsPage() {
  return (
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <div className="fixed top-0 left-1/4 w-[500px] h-[500px] bg-rose-900/10 rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="fixed top-1/3 right-1/4 w-[400px] h-[400px] bg-rose-900/8 rounded-full blur-[100px] pointer-events-none z-0" />
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono text-slate-600 mb-6">
          ...
          <span>/</span>
          <span className="text-rose-400">reports</span>
        </div>

        {/* Page Header */}
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-rose-500/10 border border-rose-500/20 text-rose-400">
              <AlertTriangle className="w-5 h-5" />
            </div>
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">Content Reports</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">Review flagged content and take moderation actions.</p>
            </div>
          </div>
