...
import { Menu, Search, Bell, Moon, ArrowLeft, Users } from 'lucide-react';
import UsersTable from '@/components/admin/tables/UsersTable';

export const metadata = {
  title: 'User Management | MugiSub Admin',
    ...
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono text-slate-600 mb-6">
          ...
          <span>/</span>
          <span className="text-violet-400">users</span>
        </div>

        {/* Page Header */}
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-violet-500/10 border border-violet-500/20 text-violet-400">
              <Users className="w-5 h-5" />
            </div>
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">User Management</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">View, search, and manage all registered platform users.</p>
            </div>
          </div>
