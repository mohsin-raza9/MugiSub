...
import { Menu, Search, Bell, Moon, ArrowLeft, User } from 'lucide-react';
import CharacterForm from '@/components/admin/forms/CharacterForm';

export const metadata = {
  title: 'Add Character | MugiSub Admin',
  description: 'Create a new character profile in the platform database.',
};
...
export default function AddCharacterPage() {
  return (
    <div className="min-h-screen bg-[#0a0f18] text-[#e2e8f0] font-sans antialiased">
      ...
      <div className="fixed top-0 left-1/4 w-[500px] h-[500px] bg-emerald-900/10 rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="fixed top-1/3 right-1/4 w-[400px] h-[400px] bg-emerald-900/8 rounded-full blur-[100px] pointer-events-none z-0" />
      <div className="fixed bottom-10 left-10 w-[300px] h-[300px] bg-emerald-900/5 rounded-full blur-[80px] pointer-events-none z-0" />
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-4 pt-10 pb-20">
        ...
        <div className="flex items-center justify-between border-b border-[#1d2433] pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black uppercase tracking-wider text-white font-mono">Add Character</h1>
              <p className="text-[11px] font-mono text-slate-500 mt-0.5">Create a new character profile in the platform database.</p>
            </div>
          </div>
